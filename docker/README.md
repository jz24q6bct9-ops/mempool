...
**Need help setting up Bitcoin Core with txindex, Electrum Server, or API keys?** See our **[Complete Setup Guide](../SETUP_GUIDE.md)** for detailed instructions on connecting all components.
